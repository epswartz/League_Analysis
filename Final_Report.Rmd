...
* **championClass** (Categorical): Which class of character the player was playing during the game.                           deaths              | Numeric     | How many times the player died during the game                                            firstDragon         | Categorical | Which team killed the first Dragon, a neutral monster.                                    firstTower          | Categorical | Which team destroyed the first tower, a defensive building                                                                                                                                          |
